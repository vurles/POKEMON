...
var PackageLockParser = /** @class */ (function () {
    ...
    PackageLockParser.prototype.getDependencyTree = function (manifestFile, lockfile, includeDev, strict) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var packageLock, depTree, depMap, depGraph, cycleStarts, cycles, _i, cycles_1, cycle, depTrees, topLevelDeps, _a, topLevelDeps_1, dep, depName;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = 0, topLevelDeps_1 = topLevelDeps;
                        _b.label = 2;
                    case 2:
                        if (!(_a < topLevelDeps_1.length)) return [3 /*break*/, 6];
                        dep = topLevelDeps_1[_a];
    ...
    */
    ...
    PackageLockParser.prototype.createDepTrees = function (depMap, depGraph) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var depTrees, depOrder, depKey, dep, _i, _a, subDepPath, subDep, pkgTree;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        _b.sent();
                        return [3 /*break*/, 1];
                    case 3: return [2 /*return*/, depTrees];
                }
            });
        });
    };
