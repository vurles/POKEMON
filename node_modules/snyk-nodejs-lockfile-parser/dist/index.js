...
function buildDepTree(manifestFileContents, lockFileContents, includeDev, lockfileType, strict, manifestFilePath) {
    if (includeDev === void 0) { includeDev = false; }
    if (strict === void 0) { strict = true; }
    if (manifestFilePath === void 0) { manifestFilePath = 'package.json'; }
