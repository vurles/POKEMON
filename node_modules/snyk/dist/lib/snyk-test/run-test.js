...
function runTest(packageManager, root, options) {
    return __awaiter(this, void 0, void 0, function () {
        var policyLocations, hasDevDependencies, spinnerLbl, payload, filesystemPolicy, depGraph, res, policy, seen_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, snyk.policy.loadFromText(res.policy)];
                case 5:
                    policy = _a.sent();
...
function assembleLocalPayload(root, options, policyLocations) {
    return __awaiter(this, void 0, void 0, function () {
        var plugin, moduleInfo, analysisType, spinnerLbl, inspectRes, pkg, gemfileLockBase64, gemfileLockContents, depGraph, policy, err_1, payload;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
